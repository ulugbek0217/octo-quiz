...
func main() {
	...
	options := []bot.Option{
		...
		bot.WithCallbackQueryDataHandler("insert_words_into", bot.MatchTypePrefix, app.InsertWordsIntoTestSet),
		bot.WithCallbackQueryDataHandler("finish_inserting_words_into", bot.MatchTypeExact, app.TeacherFinishWordInserting),
